...
function fullSync({client, dataStore}) {
    ...
    do {
        ...
        let response = client.fetchSync("/api/now/table/task?sysparm_query=active%3Dtrue&sysparm_limit=100&sysparm_offset=" + sysparm_offset)
...
function uploadAttachment({client, actionParameters}) {
    console.log(`attaching file(s) to table ${actionParameters.table_name}, table_sys_id ${actionParameters.table_sys_id}`);
